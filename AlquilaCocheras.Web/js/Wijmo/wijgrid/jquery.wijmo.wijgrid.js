...
(function (wijmo) {
    ...
    wijmo.c1basefield_options = c1basefield_options;    
    ;
...
(function (wijmo) {
    ...
    })(wijmo.c1basefield_options);
    wijmo.c1field_options = c1field_options;    
    ;
    //c1field.prototype.options = $.extend(true, {}, c1basefield.prototype.options, new c1field_options());
    c1field.prototype.options = wijmo.grid.extendWidgetOptions(wijmo.c1basefield.prototype.options, new c1field_options());
...
(function (wijmo) {
    ...
    })(wijmo.c1field_options);    
    ;
    //c1band.prototype.options = $.extend(true, {}, c1basefield.prototype.options, new c1band_options());
    c1band.prototype.options = wijmo.grid.extendWidgetOptions(wijmo.c1basefield.prototype.options, new c1band_options());
