            ...
            <div class="z-depth-4 card-panel">
                ...
                <div class="row">
                    <div class=" col s12 m12 input-field">
                        <asp:Label ID="label1" runat="server" Text="Ubicación: "></asp:Label>
                        <asp:TextBox ID="txtUbicacion" runat="server" ClientIDMode="Static" MaxLength="200"></asp:TextBox>
                ...
                <div class="row">
                    <div class=" col s12 m12 center-align input-field">
                        ...
                        <asp:TextBox ID="txtDescripcion" runat="server" ClientIDMode="Static" MaxLength="500"></asp:TextBox>
                ...
                <div class="row">
                    <div class=" col s12 m6 input-field">
                        ...
                        <asp:TextBox ID="txtLatitud" runat="server" ClientIDMode="Static" MaxLength="10"></asp:TextBox>
                        ...
                        <asp:RegularExpressionValidator ID="revLatitud" runat="server" ControlToValidate="txtLatitud"
                            ...
                            ValidationExpression="(^-?([0-9]{1,2}(\.)[0-9]{1,6})$)|(^([0-9]{0,3})$)" ForeColor="Red">*</asp:RegularExpressionValidator>
                    </div>
                    <div class=" col s12 m6 input-field">
                        <asp:Label ID="label11" runat="server" Text="Longitud: "></asp:Label>
                        <asp:TextBox ID="txtLongitud" runat="server" ClientIDMode="Static" MaxLength="10"></asp:TextBox>
...
<%--                </div>--%>
                ...
                <div class="row">
                    <div class=" col s12 m6 input-field">
                        ...
                        <asp:TextBox ID="txtMetrosCuadrados" runat="server" ClientIDMode="Static" MaxLength="10"></asp:TextBox>
                    ...
                    <div class=" col s12 m6 input-field">
                        <asp:Label ID="label9" runat="server" Text="Precio por Hora: "></asp:Label>
                        <asp:TextBox ID="txtPrecioHora" runat="server" ClientIDMode="Static" MaxLength="15"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class=" col s12 m6 input-field">
                        <asp:Image ID="imgFoto" runat="server" style="height:100%;width:100%" />
                    </div>
                </div>
                <div class="row">
                    <div class=" col s12 m12 center-align input-field">
